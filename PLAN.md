...
> 12. **No `MONITOR` rule exists for `no_procedure`**, deliberately. Without a procedure and without a clinician's baseline, "this is expected, do nothing" is not a statement this system is entitled to make. The floor there is "book a GP appointment."
